...
class MDODNetwork(NetworkABC):
    ...
    def build(self):
        ...
        # First conv was changed to reduce the size of outputs
        self.net['detector'] = nn.Sequential(
            nn.Conv2d(self.num_fmap_ch, self.num_filters, 4, 2, 1, bias=True),
        ...
        for r in self.ft_extractor.get_fmap2img_ratios():
            f_map_h = math.floor(self.input_size[0] * r)
            f_map_w = math.floor(self.input_size[1] * r)
